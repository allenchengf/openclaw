...
echo "▶ [2/4] 在 VM 上啟動 Caddy 反向代理（自動 HTTPS：${DOMAIN}）"
# 寫 Caddyfile 並以 host network 跑 Caddy（綁 80/443、反代到 clawdbot 的 8080）
...
echo "▶ [3/4] 更新 clawdbot 的對外 URL 為 ${PUBLIC_URL}（control UI allowedOrigins / 頻道 audience）"
